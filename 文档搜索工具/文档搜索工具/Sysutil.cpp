...
void DirestionList(const string& Path, vector<string> &subfile, vector<string> &subdir)
{
	string _path = Path;
	_path += "\\*.*";
	_finddata_t file;
...
/* CSDN£ºhttp://blog.csdn.net/csnd_ayo */

std::string ChineseConvertPinYinAllSpell(const std::string& dest_chinese)
{
	static const int spell_value[] = { -20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032, -20026,
